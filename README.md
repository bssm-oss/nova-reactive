...
// build.gradle.kts
dependencies {
    implementation("io.github.bssm-oss:nova-core:1.0-SNAPSHOT")

    // 사용할 데이터베이스 다이얼렉트만 추가합니다
    implementation("io.github.bssm-oss:nova-dialect-postgresql:1.0-SNAPSHOT")
}
```
...
```kotlin
// build.gradle.kts
implementation("io.github.bssm-oss:nova-metrics-micrometer:1.0-SNAPSHOT")
...
// build.gradle.kts
dependencies {
    implementation("io.github.bssm-oss:nova-spring-boot-starter:1.0-SNAPSHOT")
    implementation("io.github.bssm-oss:nova-dialect-postgresql:1.0-SNAPSHOT")
...
JPA/Spring Data 사용자에게 익숙한 `interface ... extends ReactiveCrudRepository<T, ID>` 패턴을 별도 의존(`io.github.bssm-oss:nova-spring-data:1.0-SNAPSHOT`)으로 제공합니다. Spring Data Commons에는 의존하지 않으며 Spring Framework `spring-context`만 사용합니다.
