...
JPA/Spring Data 사용자에게 익숙한 `interface ... extends ReactiveCrudRepository<T, ID>` 패턴을 별도 의존(`io.nova:nova-spring-data:1.0-SNAPSHOT`)으로 제공합니다. Spring Data Commons에는 의존하지 않으며 Spring Framework `spring-context`만 사용합니다.
