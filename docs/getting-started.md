...
Nova `2.29.0` is available from Maven Central. Nova runs on Java 17 and
...
dependencies {
    implementation("io.github.bssm-oss:nova:2.29.0")
...
// build.gradle.kts
dependencies {
    implementation("io.github.bssm-oss:nova-core:2.29.0")
    implementation("io.github.bssm-oss:nova-r2dbc:2.29.0")
...
> **Source builds**: the development default is `2.29.0-SNAPSHOT`. Build from
