...
Nova `2.28.0` is available from Maven Central. Nova runs on Java 17 and
...
dependencies {
    implementation("io.github.bssm-oss:nova:2.28.0")
...
// build.gradle.kts
dependencies {
    implementation("io.github.bssm-oss:nova-core:2.28.0")
    implementation("io.github.bssm-oss:nova-r2dbc:2.28.0")
