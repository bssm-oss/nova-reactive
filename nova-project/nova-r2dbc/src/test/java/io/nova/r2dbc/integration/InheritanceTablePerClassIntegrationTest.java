...
class InheritanceTablePerClassIntegrationTest {
    ...
    @Test
    void rejectsAutoGeneratedKeysForEveryTablePerClassSubtypeBeforeSchemaDdl() {
        assertThrows(IllegalArgumentException.class,
                () -> support.metadataFactory().getEntityMetadata(AutoTCar.class));
        assertThrows(IllegalArgumentException.class,
                () -> support.metadataFactory().getEntityMetadata(AutoTTruck.class));
    ...
    @Entity
    @Table(name = "auto_t_vehicle")
    @Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
    abstract static class AutoTVehicle {
        @Id
        @GeneratedValue
        private Long id;
    }
    ...
    @Entity
    @Table(name = "auto_t_car")
    static class AutoTCar extends AutoTVehicle {
        private int doors;
    }

    @Entity
    @Table(name = "auto_t_truck")
    static class AutoTTruck extends AutoTVehicle {
        private double payload;
    }
}
