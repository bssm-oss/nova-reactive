 ...
 * 라이브러리에 의존하지 않는다.
 * <p>
 * 컬럼 이름은 {@link jakarta.persistence.Column}/naming strategy가 결정하고, 컬럼의 SQL 타입은 dialect의
 * {@link io.nova.sql.Dialect#jsonColumnType()}(기본 {@code json}, PostgreSQL {@code jsonb})이
 * 결정한다. {@link jakarta.persistence.Enumerated}, 사용자가 등록한 {@link io.nova.convert.AttributeConverter},
