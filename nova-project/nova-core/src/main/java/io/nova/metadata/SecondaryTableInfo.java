 ...
 * @param foreignKeyMode  PK 조인 외래 키 제약 모드
 * @param foreignKeyName  명시적 PK 조인 외래 키 제약 이름
 */
public record SecondaryTableInfo(
        ...
        ConstraintMode foreignKeyMode,
        String foreignKeyName
) {
    public SecondaryTableInfo {
        schema = schema == null ? "" : schema;
        foreignKeyMode = foreignKeyMode == null ? ConstraintMode.PROVIDER_DEFAULT : foreignKeyMode;
        foreignKeyName = foreignKeyName == null ? "" : foreignKeyName;
    }
