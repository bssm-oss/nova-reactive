...
/**
 * 복합키(@EmbeddedId) 관계의 MariaDB DDL/SQL 렌더링을 잠근다. MariaDB는 MySQL과 wire 호환으로 backtick
 * 식별자 quoting, 위치 기반 {@code ?} bind marker, ANSI 타입 토큰(bigint/integer/varchar)을 수용한다.
 */
class MariaDbCompositeKeyRenderingTest {
